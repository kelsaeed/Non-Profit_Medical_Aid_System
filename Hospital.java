public class Hospital {
    ...
    private Hospital(String hospitalID, String name, Address address, String contactNumber, int numberOfBeds) {
    ...
    public static Hospital getInstance(String hospitalID, String name, Address address, String contactNumber, int numberOfBeds) {
        if (instance == null) {
            instance = new Hospital(hospitalID, name, address, contactNumber, numberOfBeds);
        }
        return instance;
    }
